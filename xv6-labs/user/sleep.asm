...
int main(int argc,char** argv)
{
  ...
  36:	336080e7          	jalr	822(ra) # 368 <sleep>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c0:	46c50513          	addi	a0,a0,1132 # 828 <digits>
 3c4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48c:	3a0b8b93          	addi	s7,s7,928 # 828 <digits>
 ...
 5cc:	25890913          	addi	s2,s2,600 # 820 <malloc+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 694:	1b07b783          	ld	a5,432(a5) # 840 <freep>
 ...
 6c2:	00e6ea63          	bltu	a3,a4,6d6 <free+0x50>
{
 ...
 704:	14f73023          	sd	a5,320(a4) # 840 <freep>
}
 708:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 736:	10e53503          	ld	a0,270(a0) # 840 <freep>
 ...
 75e:	0e690913          	addi	s2,s2,230 # 840 <freep>
  if(p == (char*)-1)
 762:	5afd                	li	s5,-1
 764:	a88d                	j	7d6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 766:	00000797          	auipc	a5,0x0
 76a:	0e278793          	addi	a5,a5,226 # 848 <base>
 76e:	00000717          	auipc	a4,0x0
 772:	0cf73923          	sd	a5,210(a4) # 840 <freep>
 776:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 798:	0aa73623          	sd	a0,172(a4) # 840 <freep>
      return (void*)(p + 1);
